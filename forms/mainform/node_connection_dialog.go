...
func NewNodeConnectionDialog(parent uiinterfaces.Widget, cl *client.Client, cloudByDefault bool, first bool) *NodeConnectionDialog {
	...
	if c.client == nil || c.client.SessionToken() == "" {
		...
		pLeft.SetPanelPadding(20)
		pLeft.SetBorderRight(1, c.AccentColor())
		imgBox := pLeft.AddImageBoxOnGrid(0, 0, uiresources.ResImgCol(uiresources.R_icons_material4_png_action_settings_ethernet_materialiconsoutlined_48dp_1x_outline_settings_ethernet_black_48dp_png, c.AccentColor()))
		...
		c.panelButtonsTransport.SetCellPadding(0)
		...
		c.btnTransportLocal.SetMouseCursor(ui.MouseCursorPointer)
