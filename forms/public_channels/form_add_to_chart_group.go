...
func NewFormAddToChartGroup(parent uiinterfaces.Widget, client *client.Client, items []string, allItems []string) *FormAddToChartGroup {
	...
	img := pLeft.AddImageBoxOnGrid(0, 0, uiresources.ResImgCol(uiresources.R_icons_material4_png_action_timeline_materialiconsoutlined_48dp_1x_outline_timeline_black_48dp_png, c.AccentColor()))
